...
# desc = 'Cifar10'; data_path = '../../data/cifar10/'; image_size = 256
desc = 'music'; data_path = '../../../data/all_classic_7.data.shrunk10000.npy'; image_size = 256
...
# data_initilize = 'build_keyed_sample_list'; data_initilize_kwargs = {}
data_initilize = 'load_npz'; data_initilize_kwargs = {'data_path':data_path}
...
# Minibatch selector
data_selector = 'select_minibatch_gan'
...
network = 'pro_gan'; training_function = 'train_pro_gan()'; minibatch_size = {2:64, 3:64, 4:64, 5:32, 6:32, 7:32, 8:16}; stage_length = int(800e3); trans_length = int(800e3)
...
img_per_save        = int(160e3)
img_per_val         = int(128e3)
logs_path           = 'logs/' + desc
# restore             = None; start_img = 0
restore             = 'logs/music-pro_gan-run_20191027171540/models/model-9600.ckpt'; start_img = int(7200e3)
